...
DOCTEST_MSVC_SUPPRESS_WARNING(26812) // Enum type is unscoped, prefer enum class over enum
...
const char* assertString(assertType::Enum at) {
    ...
    DOCTEST_MSVC_SUPPRESS_WARNING_WITH_PUSH(26812)// enum 'x' in switch of enum 'y' is not handled
